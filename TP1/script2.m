...
cantidad_pruebas = 20; %cantidad de veces que tiro el algoritmo
...
for i = 1:cantidad_pruebas
    ...
    [X, MejorValor, Soluciones, Valores] = hillClimbing01(f, X0, Bounds, max_eps, cant_iterac);
