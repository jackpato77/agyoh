...
Trace_R = []; % para guardar los vectores dirección

%c_malas=0;  %contador de iteraciones con valor de la función menor a la solución actual 
%m_malas=10; %maximo nro de iteraciones con valor de la función menor a la solución actual
